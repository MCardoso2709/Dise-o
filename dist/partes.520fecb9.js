 ...
 */ /*global window, document*/ (function(exports) {
    "use strict";
    var extend, simplyCountdown1;
    extend = function(out) {
        var i, obj, key;
        out = out || {};
    ...
    simplyCountdown1 = function(eltId, args) {
        ...
        }, args), targetDate = new Date(parameters.year, parameters.month - 1, parameters.day), currentDate, secondsLeft, days, hours, minutes, seconds, countdown = document.getElementById(eltId);
        window.setInterval(function() {
            var spanTag, sectionTag, amountTag, sectionTagInnerContainer, wordTag, dayWord, hourWord, minuteWord, fullCountDown, secondWord;
            ...
            /* display an inline countdown into a span tag */ if (parameters.inline) {
                spanTag = document.createElement("span");
                spanTag.classList.add(parameters.inlineClass);
                spanTag.innerHTML = days + " " + dayWord + ", " + hours + " " + hourWord + ", " + minutes + " " + minuteWord + ", " + seconds + " " + secondWord + ", ";
    ...
    exports.simplyCountdown = simplyCountdown1;
})(window);
/*global $, jQuery, simplyCountdown*/ (function($, simplyCountdown1) {
    "use strict";
    function simplyCountdownify(el, options) {
        simplyCountdown1(el, options);
    }
...
//# sourceMappingURL=partes.520fecb9.js.map
