 ...
 */ (function($, window1, document1, undefined) {
	 ...
	 */ Owl.prototype.registerEventHandlers = function() {
        ...
        if (this.settings.responsive !== false) this.on(window1, "resize", this._handlers.onThrottledResize);
	 ...
	 */ Owl.prototype.viewport = function() {
        var width;
        if (this.options.responsiveBaseElement !== window1) width = $(this.options.responsiveBaseElement).width();
        else if (window1.innerWidth) width = window1.innerWidth;
        else if (document1.documentElement && document1.documentElement.clientWidth) width = document1.documentElement.clientWidth;
...
(function($, window1, document1, undefined) {
	 ...
	 */ Video.prototype.play = function(event) {
        ...
        if (video.type === "youtube") html = '<iframe width="' + width + '" height="' + height + '" src="//www.youtube.com/embed/' + video.id + "?autoplay=1&rel=0&v=" + video.id + '" frameborder="0" allowfullscreen></iframe>';
        else if (video.type === "vimeo") html = '<iframe src="//player.vimeo.com/video/' + video.id + '?autoplay=1" width="' + width + '" height="' + height + '" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>';
        else if (video.type === "vzaar") html = '<iframe frameborder="0"height="' + height + '"' + 'width="' + width + '" allowfullscreen mozallowfullscreen webkitAllowFullScreen ' + 'src="//view.vzaar.com/' + video.id + '/player?autoplay=true"></iframe>';
...
(function($, window1, document1, undefined) {
	 ...
	 */ Autoplay.prototype._next = function(speed) {
        ...
        if (this._core.is("busy") || this._core.is("interacting") || document1.hidden) return;
...
(function($, window1, document1, undefined) {
	 ...
	 */ var Hash = function(carousel) {
		 ...
		 */ this._handlers = {
            "initialized.owl.carousel": $.proxy(function(e) {
                if (e.namespace && this._core.settings.startPosition === "URLHash") $(window1).trigger("hashchange.owl.navigation");
            }, this),
            "prepared.owl.carousel": $.proxy(function(e) {
                if (e.namespace) {
            ...
            "changed.owl.carousel": $.proxy(function(e) {
                if (e.namespace && e.property.name === "position") {
                    ...
                    if (!hash || window1.location.hash.slice(1) === hash) return;
...
//# sourceMappingURL=partes.68095beb.js.map
